...
async def artifact_not_found_handler(
    ...
    """Convert missing artifact failures into a clear 404 response."""
...
async def artifact_read_error_handler(
    ...
    """Convert unreadable or invalid artifacts into a clear 500 response."""
...
async def http_exception_handler(
    ...
    """Return a consistent JSON response for HTTP failures."""
...
def _validated_anomalies() -> list[dict[str, Any]]:
    """Read and validate all stored anomaly records."""
...
def _root_summary(raw_analysis: dict[str, Any]) -> RootCauseSummary:
    """Validate and convert stored root-cause data."""
...
def _incident_records(
    ...
    """Validate and enrich stored incident records."""
...
def health(response: Response) -> HealthResponse:
    """Check model and dashboard artifact readiness."""
